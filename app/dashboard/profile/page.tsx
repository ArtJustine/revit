...
import { getUserProfile, updateUserProfile, uploadProfileImage } from "@/lib/firebase/utils"
        ...
        <main className="flex-1 py-8 px-4 md:px-6 bg-gray-50">
          <div className="container mx-auto max-w-4xl">
            <div className="mb-6 flex items-center">
              <Button variant="ghost" onClick={() => router.push("/dashboard")} className="mr-4 text-gray-600">
