      ...
      <main className="flex-1 py-16 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-white p-8 rounded-xl shadow-sm">
            <h1 className="text-3xl font-bold text-[#333333] mb-6">Welcome to Your Dashboard</h1>
            <p className="text-[#666666] mb-8">
              Thank you for signing up! This is a placeholder dashboard page. In a real application, you would see your
